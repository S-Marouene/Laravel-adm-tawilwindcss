...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
    ...
    <body class="font-sans antialiased bg-white dark:bg-gray-900">
        <!-- Navigation -->
        <nav class="bg-white dark:bg-gray-800 border-b border-sand-200 dark:border-gray-700 sticky top-0 z-50 no-print">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16 items-center">
                    <a href="/" class="flex items-center gap-3 group">
                        <div class="w-9 h-9 bg-gradient-to-br from-gov-600 to-gov-800 rounded-xl flex items-center justify-center shadow-sm group-hover:shadow-md transition-all">
                    ...
                    <div class="flex items-center gap-1 sm:gap-2">
                        ...
                        @auth
                            <a href="{{ route('dashboard') }}" class="px-4 py-2 text-sm font-semibold text-white bg-gov-600 hover:bg-gov-700 rounded-lg shadow-sm hover:shadow transition-all duration-200 active:scale-[0.98]">
                                {{ __('nav.dashboard') }}
                            </a>
                        @else
                            <a href="{{ route('login') }}" class="hidden sm:inline-flex px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-gov-600 transition-colors">
                                {{ __('nav.login') }}
                            </a>
                            <a href="{{ route('register') }}" class="px-4 py-2 text-sm font-semibold text-white bg-gov-600 hover:bg-gov-700 rounded-lg shadow-sm hover:shadow transition-all duration-200 active:scale-[0.98]">
                                {{ __('nav.register') }}
                            </a>
                        @endauth
                    </div>
        ...
        <!-- Hero Section -->
        <section class="relative overflow-hidden bg-gradient-to-br from-gov-600 via-gov-700 to-gov-900">
            ...
            <div class="absolute top-0 right-0 w-96 h-96 bg-blue-400/10 rounded-full -translate-y-1/2 translate-x-1/2 blur-3xl"></div>
            <div class="absolute bottom-0 left-0 w-64 h-64 bg-indigo-400/10 rounded-full translate-y-1/2 -translate-x-1/2 blur-3xl"></div>
            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32">
                <div class="text-center max-w-3xl mx-auto">
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
                        @auth
                            <a href="{{ route('dashboard') }}" class="w-full sm:w-auto px-8 py-3.5 bg-white text-gov-700 rounded-xl font-semibold text-sm sm:text-base shadow-lg hover:shadow-xl hover:bg-blue-50 transition-all duration-200 active:scale-[0.98] text-center">
                                {{ __('nav.dashboard') }}
                            </a>
                        @else
                            <a href="{{ route('register') }}" class="w-full sm:w-auto px-8 py-3.5 bg-white text-gov-700 rounded-xl font-semibold text-sm sm:text-base shadow-lg hover:shadow-xl hover:bg-blue-50 transition-all duration-200 active:scale-[0.98] text-center">
                                {{ __('register.submit') }}
                            </a>
                            <a href="{{ route('login') }}" class="w-full sm:w-auto px-8 py-3.5 border-2 border-white/30 text-white rounded-xl font-medium text-sm sm:text-base hover:bg-white/10 transition-all duration-200 active:scale-[0.98] text-center">
                                {{ __('login.title') }}
                            </a>
                        @endauth
                    </div>
        ...
        <section class="py-12 sm:py-16 lg:py-20 bg-sand-50 dark:bg-gray-900">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    <!-- Service 1 -->
                    <a href="{{ route('login') }}" class="group bg-white dark:bg-gray-800 rounded-2xl border border-sand-200 dark:border-gray-700 p-6 transition-all duration-300 service-card hover:border-gov-200 dark:hover:border-gov-700">
                        <div class="w-14 h-14 bg-gov-50 dark:bg-gov-900/30 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <!-- Service 2 -->
                    <a href="{{ route('login') }}" class="group bg-white dark:bg-gray-800 rounded-2xl border border-sand-200 dark:border-gray-700 p-6 transition-all duration-300 service-card hover:border-gov-200 dark:hover:border-gov-700">
                        <div class="w-14 h-14 bg-blue-50 dark:bg-blue-900/30 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <!-- Service 3 -->
                    <a href="{{ route('login') }}" class="group bg-white dark:bg-gray-800 rounded-2xl border border-sand-200 dark:border-gray-700 p-6 transition-all duration-300 service-card hover:border-gov-200 dark:hover:border-gov-700">
                        <div class="w-14 h-14 bg-emerald-50 dark:bg-emerald-900/30 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <!-- Service 4 -->
                    <a href="{{ route('login') }}" class="group bg-white dark:bg-gray-800 rounded-2xl border border-sand-200 dark:border-gray-700 p-6 transition-all duration-300 service-card hover:border-gov-200 dark:hover:border-gov-700">
                        <div class="w-14 h-14 bg-amber-50 dark:bg-amber-900/30 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <!-- Service 5 -->
                    <a href="{{ route('login') }}" class="group bg-white dark:bg-gray-800 rounded-2xl border border-sand-200 dark:border-gray-700 p-6 transition-all duration-300 service-card hover:border-gov-200 dark:hover:border-gov-700">
                        <div class="w-14 h-14 bg-rose-50 dark:bg-rose-900/30 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <!-- Service 6 -->
                    <a href="{{ route('login') }}" class="group bg-white dark:bg-gray-800 rounded-2xl border border-sand-200 dark:border-gray-700 p-6 transition-all duration-300 service-card hover:border-gov-200 dark:hover:border-gov-700">
                        <div class="w-14 h-14 bg-purple-50 dark:bg-purple-900/30 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
        ...
        <!-- CTA Section -->
        <section class="py-12 sm:py-16 bg-gradient-to-br from-gov-600 to-gov-800">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                @auth
                    <a href="{{ route('dashboard') }}" class="inline-flex items-center px-8 py-3.5 bg-white text-gov-700 rounded-xl font-semibold shadow-lg hover:shadow-xl hover:bg-blue-50 transition-all duration-200 active:scale-[0.98]">
                        {{ __('nav.dashboard') }}
                    </a>
                @else
                    <a href="{{ route('register') }}" class="inline-flex items-center px-8 py-3.5 bg-white text-gov-700 rounded-xl font-semibold shadow-lg hover:shadow-xl hover:bg-blue-50 transition-all duration-200 active:scale-[0.98]">
                        {{ __('register.submit') }}
                    </a>
                @endauth
            </div>
