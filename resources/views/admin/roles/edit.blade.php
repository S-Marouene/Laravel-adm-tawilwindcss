...
@section('content')
    ...
    <div class="max-w-2xl">
        <form action="{{ route('admin.roles.update', $role) }}" method="POST" class="admin-form-card p-6 space-y-6">
            @csrf
            @method('PATCH')
            ...
            <div class="flex items-center justify-end space-x-3">
                ...
                <button type="submit" class="admin-add-button px-4 py-2 text-sm">Update Role</button>
            </div>
        </form>
    </div>
@endsection
