                ...
                <div class="px-4 sm:px-6 lg:px-8">
                    <div class="flex items-center justify-between h-16">
                        ...
                        <div class="flex items-center gap-1 sm:gap-2">
                            ...
                            <a href="{{ route('dashboard') }}" class="flex items-center gap-1.5 text-sm text-gray-500 hover:text-gov-600 dark:text-gray-400 dark:hover:text-gov-400 transition-colors touch-target px-2 py-2 group" aria-label="{{ app()->getLocale() === 'ar' ? 'الانتقال إلى لوحة التحكم' : 'Aller au tableau de bord' }}">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                                </svg>
                                <span class="hidden sm:inline">{{ __('nav.dashboard') }}</span>
                            </a>
