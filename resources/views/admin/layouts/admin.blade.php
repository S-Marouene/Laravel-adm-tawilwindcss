...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
    ...
    <body class="font-sans antialiased bg-[#F5F6FA] dark:bg-gray-900">
        <div class="min-h-screen flex" x-data="sidebarManager()">
            ...
            <aside class="hidden lg:block ynex-sidebar border-r min-h-screen flex-shrink-0 transition-all duration-300 ease-in-out overflow-hidden" :class="[sidebarWidth, { 'sidebar-collapsed': collapsed }]">
                ...
                <div x-show="!collapsed" class="px-4 pt-4 pb-2">
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-2">
                        <div class="w-8 h-8 bg-gradient-to-br from-gov-600 to-gov-800 rounded-lg flex items-center justify-center shadow-sm flex-shrink-0">
                ...
                <header class="app-header flex-shrink-0">
                    <nav class="main-header" aria-label="Global">
                        <div class="main-header-container">
                            ...
                            <!-- Sidebar Toggle (hidden on mobile, only shown on lg+) -->
                                <div class="header-element md:px-[0.325rem] !items-center max-lg:hidden">
